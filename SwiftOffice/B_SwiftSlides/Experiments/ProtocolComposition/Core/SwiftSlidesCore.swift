...
// ============================================
// SwiftSlidesCore - 核心工具库
// ============================================
//
// 此模块提供创建 PPTX 演示文稿的核心功能。
//
// 使用方式：
...
public extension Presentation {
    ...
    public func generatePPTX(outputPath: String) async throws {
...
public struct PPTXGenerator {
    ...
    private func createNodeScript(json: String, outputPath: String) -> String {
        // node_modules 在 SwiftOffice 根目录
        let nodeModulesPath = "/Users/jk/gits/hub/prog_langs/swift/swift_office/SwiftOffice/node_modules"
